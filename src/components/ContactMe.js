  ...
  return (
    <section className="contact-section">
      ...
      <p className="contact-text">
        Do you have a project we can collaborate on? I&apos;d love to hear about
        it. Also, I&apos;m open to discussing topics related to web development.
        Send me a message on any of my social media account or fill out the form
        below.
      </p>
